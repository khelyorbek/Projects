...
class User {
  ...
  static async get(username) {
    ...
    let userApps = appsRes.rows[0];

    // If there are no results, the jobs variable will be replaced by a message.
    if (!userApps) {userApps = `No job applications were found for this user.`};
  ...
  // Incorporate into the app by adding a method onto the User model, allowing users to apply for a job.
